  ...
  return (
    <section className="overflow-x-hidden w-full  ">
      <div className="md:w-full text-left md:h-[52px]  ">
        <h1 className="font-bold text-xl py-3 pl-5">New Arrivals</h1>
      </div>
            ...
            return (
              <div key={i}>
                <div className="flex flex-row overflow-x-scroll space-x-5 py-5 ">
                  <div className="w-[240px] space-y-3 px-5 border rounded-lg h-[250px] whitespace-normal text-left bg-slate-300">
